...
"""
    ...
    def generate_isim_makefile(self, fileset, top_module):
        ...
        self.writeln('PRJVHDL := $(TESTBENCH)_vhdl.prj')
        self.writeln('PRJVL := $(TESTBENCH)_vl.prj')
        self.writeln()
        self.writeln('all: compile')
        self.writeln()
        self.writeln('.PHONY: analyze view')
        self.writeln()
        self.writeln('check_path:')
        self.writeln('\t@TMP=$$(which $(VHDL) 2>/dev/null) ; \\')
        self.writeln('\tif ! [ -x "$$TMP"  ] ; then \\')
        self.writeln('\t\techo "Cannot find vhpcomp in PATH, please initialize Xilinx." ; \\')
        self.writeln('\t\texit -1 ; \\')
        self.writeln('\tfi')
        self.writeln()
        self.writeln('analyze:check_path $(PRJVHDL) $(PRJVL)')
        self.writeln('\t@echo "Analyzing..."')
        self.writeln('\t$(VHDL) -prj $(PRJVHDL) -work work')
        self.writeln('\t$(VERILOG) -prj $(PRJVL) -work work')
        self.writeln()
        self.writeln('compile:analyze')
        self.writeln('\t@echo "Compiling..."')
        self.writeln('\t$(FUSE) $(TESTBENCH) -o $(TESTBENCH)')
        self.writeln()
        self.writeln('clean:')
